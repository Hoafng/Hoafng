...
Values('NV01101020220001' , '2022-10-10' , 0.1 , 'KH001' , 'NV01'),
	  ...
	  ('NV01141020220001' , null , 0.1 , 'KH023' , 'NV04'),
	  ('NV01141020220002' , null , 0.1 , 'KH012' , 'NV04'),
	  ('NV01141020220003' , null , 0.1 , 'KH013' , 'NV05'),
	  ('NV01141020220004' , null , 0.1 , 'KH011' , 'NV06'),
	  ('NV01141020220005' , null , 0.1 , 'KH023' , 'NV06'),
	  ('NV01141020220006' , null , 0.1 , 'KH023' , 'NV06')
...
Create PROCEDURE timKiemNhanVien
	...
	@tenNhanVien NVarchar(50),@gioiTinh char(1),@chucVu Nvarchar(30)
AS
BEGIN
	...
	where (tenNhanVien=@tenNhanVien or @tenNhanVien = '') and (gioiTinh=@gioiTinh or @gioiTinh='') and chucVu=@chucVu
END
