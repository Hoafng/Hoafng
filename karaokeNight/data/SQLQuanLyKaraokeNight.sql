...
Values('NV01101020220001' , '2022-10-10' , 0.1 , 'KH001' , 'NV01',1),
	  ('NV01101020220002' , '2022-10-10' , 0.1 , 'KH002' , 'NV01',1),
	  ('NV01101020220003' , '2022-10-10' , 0.1 , 'KH003' , 'NV01',1),
	  ('NV01101020220004' , '2022-10-10' , 0.1 , 'KH004' , 'NV01',1),
	  ('NV01101020220005' , '2022-10-10' , 0.1 , 'KH005' , 'NV01',1),
	  ('NV01101020220006' , '2022-10-10' , 0.1 , 'KH006' , 'NV02',1),
	  ('NV01101020220007' , '2022-10-10' , 0.1 , 'KH007' , 'NV02',1),
	  ('NV01101020220008' , '2022-10-10' , 0.1 , 'KH008' , 'NV02',1),
	  ('NV01111020220001' , '2022-10-11' , 0.1 , 'KH009' , 'NV03',1),
	  ('NV01111020220002' , '2022-10-11' , 0.1 , 'KH010' , 'NV03',1),
	  ('NV01111020220003' , '2022-10-11' , 0.1 , 'KH012' , 'NV04',1),
	  ('NV01111020220004' , '2022-10-11' , 0.1 , 'KH013' , 'NV04',1),
	  ('NV01121020220001' , '2022-10-12' , 0.1 , 'KH014' , 'NV05',1),
	  ('NV01121020220002' , '2022-10-12' , 0.1 , 'KH015' , 'NV05',1),
	  ('NV01121020220003' , '2022-10-12' , 0.1 , 'KH016' , 'NV05',1),
	  ('NV01121020220004' , '2022-10-12' , 0.1 , 'KH017' , 'NV06',1),
	  ('NV01131020220001' , '2022-10-13' , 0.1 , 'KH018' , 'NV01',1),
	  ('NV01131020220002' , '2022-10-13' , 0.1 , 'KH020' , 'NV01',1),
	  ('NV01131020220003' , '2022-10-13' , 0.1 , 'KH021' , 'NV01',1),
	  ('NV01131020220004' , '2022-10-13' , 0.1 , 'KH022' , 'NV02',1),
	  ('NV01131020220005' , '2022-10-13' , 0.1 , 'KH023' , 'NV02',1),
	  ('NV01141020220001' , null , 0.1 , 'KH023' , 'NV04',0),
	  ('NV01141020220002' , null , 0.1 , 'KH012' , 'NV04',0),
	  ('NV01141020220003' , null , 0.1 , 'KH013' , 'NV05',0),
	  ('NV01141020220004' , null , 0.1 , 'KH011' , 'NV06',0),
	  ('NV01141020220005' , null , 0.1 , 'KH023' , 'NV06',0),
	  ('NV01141020220006' , null , 0.1 , 'KH023' , 'NV06',0)
...
select * from NhanVien where tenTaiKhoan = 'nhanvien01'
select maPhong,tinhTrang,giaPhong,soLuongNguoi,p.maLoaiPhong,tenLoaiPhong from Phong p
join LoaiPhong lp on p.maLoaiPhong = lp.maLoaiPhong where lp.maLoaiPhong = ''
select * from Phong 
where tinhTrang =N'Trống'
select Distinct soLuongNguoi from Phong 
order by soLuongNguoi asc